...
class OrdersWeekdayAnalysisAPIView(generics.RetrieveAPIView):
...
class StaffTopContributorsAPIView(generics.RetrieveAPIView):
...
@swagger_auto_schema(
    method="get",
    operation_description="Get a list of all API URLs with query parameter examples.",
)
@api_view(["GET"])
def api_root(request, format=None):
    return Response(
        {
            "orders": {
                "url": reverse("order-list", request=request, format=format),
                "query_params": {
                    "customer_id": "int",
                    "store_id": "int",
                    "staff_id": "int",
                    ...
                    "min_amount": "float",
                    "max_amount": "float",
                    "delayed_orders": "true/false",
                    "premium_orders": "true/false",
                },
            },
            "create_order": {
                "url": reverse("create-order", request=request, format=format),
                "request_body": "OrderCreateSerializer",
            },
            "update_order_example": {
                "url": reverse(
                    "update-order", args=[1], request=request, format=format
                ),
                "request_body": "OrderUpdateSerializer",
            },
            "orders_by_weekday": {
                "url": reverse(
                    "order-list-by-weekday", request=request, format=format
                ),
                "query_params": {
                    "customer_id": "int",
                    "store_id": "int",
            ...
            "top_staff": {
                "url": reverse(
                    "top-contributing-staff", request=request, format=format
                ),
                "query_params": {
            ...
            "bikes_by_brand_example": {
                "url": reverse(
                    "bikes-by-brand", args=[1], request=request, format=format
                ),
                "query_params": {
                    "min_price": "float",
                    "max_price": "float",
