...
from . import views
from .views import api_root  # import the api_root view
...
urlpatterns = [
    ...
    # Hyperlinked index at "/api/"
    path("apis/", api_root, name="api-root"),
    path("api/orders/", views.OrdersListAPIView.as_view(), name="order-list"),
    path(
